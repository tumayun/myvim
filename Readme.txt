1. 概述 					|tumayun-intro|
2. 使用的插件					|tumayun-plugin|
3. 插件功能简介					|tumayun-plugin-description|
4. 快捷键一览   				|tumayun-shortcut|
5. 其他说明     				|tumayun-shortcut|

==============================================================================
						*tumayun-intro*
1. Overview~

本文档是tumayun的vim相关配置文件和插件的说明。这些插件和设置是完全根据个人喜好来
...
<
    ...
    * <CTRL-O><enter> 在insert模式下执行。会把光标处的单词转化为tag，并自动换
    ...
    示例（输入a后按<CTRL-O><CTRL-SPACE>，^为光标位置）：
>
	<a>^</a>
<
    3.16 surround~
